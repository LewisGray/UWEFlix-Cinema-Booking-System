...
from UWEFlix.models import Film, Booking,Club
...
def removeBooking(request, booking_id):
    ...
    return render(request, "UWEFlix/bookingCRUD/remove_booking.html", {"booking_name": booking.id})
...
def removeUser(request, username):
    ...
    return render(request, "UWEFlix/userCRUD/remove_user.html", {"username": user.username})
